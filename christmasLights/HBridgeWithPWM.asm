...
;**********************************************************************
    ...
    psect	powerup,class=CODE,delta=2,reloc=2
powerup:
    nop	; Suggested Microchip errata workaround
    goto	start

    ;objects in Common RAM - address 70h
PSECT MainData,global,class=myData,space=1,delta=1,noexec
    ;objects in Common RAM - address 70h
...
;**********************************************************************
PSECT   myISR,global,class=CODE,delta=2
    global  myISR
